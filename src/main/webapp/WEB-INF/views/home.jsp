...
<body>
	<header role="banner" class="cabecalhoPrincipal container">
		<h1 class="cabecalhoPrincipal-titulo">
			<a tabindex="1" href="/" class="cabecalhoPrincipal-linkTitulo" title="Casa do Código - Livros e Tecnologia">
		...
		<div id="navegacaoCabecalho" class="cabecalhoPrincipal-navegacao">
			<div class="cabecalhoPrincipal-categoriasEBusca" role="presentation">
				...
				<form role="search" aria-labelledby="rotuloBuscaPrincipal" action="/search"
					...
					<input id="campoBuscaPrincipal" class="buscaPrincipal-campo" placeholder="O que procura?"
						   type="search" name="q" required="required" />
						...
						<ul class="grupoCaelum-column-list">
							...
							<li class="column-item">
								<a href="http://www.casadocodigo.com.br">
									<img class="column-item-logo" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/footer-icon-cdc.svg?6587815016992574778" />
						...
						<ul class="grupoCaelum-column-list">
							<li class="column-item">
								<a href="http://www.alura.com.br">
									<img class="column-item-logo" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/footer-icon-alura.svg?6587815016992574778#alura"/>
									<span class="column-item-title">Alura</span>
								</a>
							</li>
							<li class="column-item">
								<a href="http://www.alurastart.com.br">
									<img class="column-item-logo" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/footer-icon-alurastart.svg?6587815016992574778"/>
									<span class="column-item-title">Alura Start</span>
								</a>
							</li>
							<li class="column-item">
								<a href="http://www.musicdot.com.br">
									<img class="column-item-logo" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/footer-icon-musicdot.svg?6587815016992574778"/>
									<span class="column-item-title">MusicDot</span>
								</a>
							</li>
							<li class="column-item">
								<a href="http://www.aluralingua.com.br">
									<img class="column-item-logo" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/footer-icon-aluralingua.svg?6587815016992574778"/>
						...
						<ul class="grupoCaelum-column-list">
							<li class="column-item">
								<a href="http://hipsters.tech">
									<img class="column-item-logo" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/footer-icon-hipsters-pontotech.svg?6587815016992574778"/>
									<span class="column-item-title">Hipsters ponto Tech</span>
								</a>
							</li>
							<li class="column-item">
								<a href="http://hipsters.jobs">
									<img class="column-item-logo" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/footer-icon-hipsters-jobs.svg?6587815016992574778"/>
									<span class="column-item-title">Hipsters ponto Jobs</span>
								</a>
							</li>				
							<li class="column-item">
								<a href="http://www.guj.com.br">
									<img class="column-item-logo" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/footer-icon-guj.svg?6587815016992574778"/>
									<span class="column-item-title">GUJ</span>
								</a>
							</li>
						</ul>
					</li>
						...
						<ul class="grupoCaelum-column-list">
							<li class="column-item">
								<a href="http://www.imasters.com.br">
									<img class="column-item-logo" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/footer-icon-imasters.svg?6587815016992574778"/>
									<span class="column-item-title">iMasters</span>
								</a>
							</li>
						</ul>
					</li>
